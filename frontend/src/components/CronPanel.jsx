...
export default function CronPanel({ cronJobs, busyKey, onToggle }) {
  return (
                  ...
                  <tr key={job.id}>
                    ...
                    <td>
                      <div className="table-actions">
                        <button onClick={() => onToggle(job.id)} disabled={busyKey === `cron-${job.id}`}>
                          {job.enabled ? 'Pause' : 'Enable'}
                        </button>
                        <button disabled title="Manual trigger is not wired to Hermes scheduler yet">
                          Trigger unavailable
                        </button>
                      </div>
                    </td>
